---
name: create-mr
description: "Создаёт Merge Request в GitLab из текущей ветки через glab: автоматически генерирует заголовок и описание, задаёт не более двух вопросов (целевая ветка если найдена release-ветка, и draft), затем пушит ветку и публикует MR. Если MR уже существует для текущей ветки с тем же target, скилл обновляет его описание без лишних вопросов. Используй этот скилл всякий раз, когда пользователь просит «создать MR», «открыть merge request», «запушить ветку и создать MR», «сделать PR/MR в GitLab», «залить ветку на ревью» или любую похожую формулировку."
---
...
2. [Шаг 1.5 — Определение целевой ветки](#шаг-15--определение-целевой-ветки)
3. [Шаг 2 — Проверь существующий MR](#шаг-2--проверь-существующий-mr)
4. [Шаг 3 — Один вопрос](#шаг-3--один-вопрос)
5. [Шаг 4 — Заголовок MR](#шаг-4--заголовок-mr)
6. [Шаг 5 — Push ветки](#шаг-5--push-ветки)
7. [Шаг 6 — Описание MR](#шаг-6--описание-mr)
8. [Шаг 7 — Создай MR](#шаг-7--создай-mr)
9. [Шаг 8 — Итог](#шаг-8--итог)
...
```bash
# 1. Попробуй извлечь Jira-тикет из имени текущей ветки
